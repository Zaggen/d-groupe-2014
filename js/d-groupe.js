...
(function() {
  var $, backToListBtn, baseFolder, mainNav, news, newsCollection, newsNavi, newsViewCollection, root, rootUrl, router,
  ...
  App.Views.navigation = (function(_super) {
  ...
  App.Routers.Router = (function(_super) {
    ...
    Router.prototype.navigateOnLoad = function() {
      ...
      this.navigate('/');
      return this.navigate(linkTarget, true);
    };
  ...
  $((function(_this) {
    return function() {
      ...
      router.on('route:onSection', function(slide) {
        return router.navigateSection(slide, 'on');
      });
      router.on('route:musicSection', function(slide) {
        return router.navigateSection(slide, 'music');
      });
      router.on('route:corpSection', function(slide) {
        return router.navigateSection(slide, 'corp');
      });
      router.on('route:eventsSection', function(slide) {
        return router.navigateSection(slide, 'event');
      });
