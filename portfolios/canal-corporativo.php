    ...
    <header class="portfolioHeader">
        ...
        <div class="grid_4">
            <ul class="portfolioBtns navigator">
                <li><a href="/portafolio/corporativo/fotos" class="portfolioBtn picsBtn route"></a></li>
                <li><a href="/portafolio/corporativo/videos" class="portfolioBtn vidsBtn route"></a></li>
                <li><a href="/portafolio/corporativo/calendario" class="portfolioBtn calendarBtn route"></a></li>
                <li><a href="/portafolio/corporativo/contacto" class="portfolioBtn contactBtn route"></a></li>
            </ul>
        </div>
    </header>
